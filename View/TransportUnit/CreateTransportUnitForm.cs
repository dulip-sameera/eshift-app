...
{
    public partial class CreateTransportUnitForm : Form
    {
        ...
        public CreateTransportUnitForm()
        {
            InitializeComponent();
        ...
        private void btnAddDriver_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (transportUnitController.IsDriverInTransportUnit(staffDto.Id ?? 0))
                {
        ...
        private void btnAddAssistant_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (transportUnitController.IsAssistantInTransportUnit(staffDto.Id ?? 0))
                {
        ...
        private void btnAddVehicle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (transportUnitController.IsVehicleInTransportUnit(dbId))
                {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Please add valid driver, assistant, and vehicle before creating.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                // Generate TU ID
                string tuId = TransportUnitIdGenerator.GenerateNextTransportUnitId();
                ...
                var transportUnitDto = new TransportUnitDto(
                    ...
                    available: TransportUnitAvailableEnum.YES
                );

                transportUnitController.CreateTransportUnit(transportUnitDto);
                MessageBox.Show("Transport unit created successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                windowClose();
                // Optionally refresh the transport unit form
            ...
            {
                Console.WriteLine($"Error creating transport unit: {ex.Message}");
